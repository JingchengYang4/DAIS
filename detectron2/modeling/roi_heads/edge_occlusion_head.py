...
class Edge_Occlusion(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        self.edge_conv0 = nn.Conv2d(in_channels=1, out_channels=16, kernel_size=3, stride=1, padding=1)
        self.edge_conv1 = nn.Conv2d(in_channels=16, out_channels=8, kernel_size=3, stride=1, padding=1)#size of 7
        self.edge_conv2 = nn.Conv2d(in_channels=8, out_channels=4, kernel_size=3, stride=1, padding=1)#I BELIEVE OUPUT SIZE IS 3
        self.edge_conv3 = nn.Conv2d(in_channels=4, out_channels=2, kernel_size=3, stride=1, padding=1)
        ...
        self.fconv = nn.Conv2d(in_channels=2, out_channels=1, kernel_size=1)
